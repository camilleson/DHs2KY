...
export default function Hero() {
  return (
    <section
      className="relative w-full min-h-[100vh] flex flex-col justify-between items-center py-20 overflow-hidden bg-cover bg-center"
    ...
    >
      ...
      <div className="z-10 w-full text-center fade-in pt-6">
        <h1 className="font-cursive text-[50px] text-[#333333] font-light tracking-wide">
          Dongho
        </h1>
      </div>
      ...
      <div className="z-10 w-full px-8 flex justify-between items-end fade-in mt-auto pb-2 whitespace-nowrap">
        <div className="text-left">
          <p className="font-sans text-[14px] tracking-widest text-black font-medium mb-1 whitespace-nowrap">
            THE BMK WEDDING
          </p>
          <p className="font-sans text-[14px] tracking-widest text-black font-medium whitespace-nowrap">
            ASTIN HALL
          </p>
        </div>
